...
const Icons = {
  ...
  refreshCw: (p) => (
    <Icon {...p} d="M21 2v6h-6M3 12a9 9 0 0115-6.7L21 8M3 22v-6h6M21 12a9 9 0 01-15 6.7L3 16" />
  ),
  externalLink: (p) => (
    <Icon {...p} d="M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6M15 3h6v6M10 14L21 3" />
  ),
  info: (p) => (
    <svg
      width={p.size || 16}
        ...
        {showDetail && (
          ...
          >
            <p style={{ fontSize: 13, color: c.textSecondary, margin: 0, lineHeight: 1.6 }}>
              ...
              toggles may have been left off. Clicking "Fix permissions" will let you re-grant them
    ...
    <Card style={{ overflow: 'hidden', ...slideUp(0) }}>
      ...
      <div style={{ padding: '20px 22px' }}>
        ...
        >
          <div style={{ display: 'flex', gap: 10 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 13, color: c.textSecondary, margin: 0, lineHeight: 1.6 }}>
                If your organization uses a managed Microsoft 365 account, you may see an "Admin
                approval required" screen. This only needs to happen{' '}
                <strong>once for your entire company</strong> — after your IT admin approves, all
                colleagues can connect without this step.
              </p>
            </div>
          </div>
        </div>
        ...
        {[
          ...
          {
            step: '3',
            text: 'If prompted for admin approval, click "Request approval" and ask your IT admin',
          },
          ...
          >
            ...
            <span style={{ fontSize: 13, color: c.textSecondary, lineHeight: 1.5, paddingTop: 2 }}>
              {text}
            </span>
          </div>
        ))}
...
function O365WaitingCard({ onTryAgain, onCancel }) {
  return (
    <Card style={{ padding: '40px 32px', textAlign: 'center', ...slideUp(0) }}>
      ...
      >
        You've requested access, but your company's Microsoft administrator needs to approve the
        Balo calendar integration in their admin portal.
      </p>
