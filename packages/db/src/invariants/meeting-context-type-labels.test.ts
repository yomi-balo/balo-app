 ...
 *   2. The polymorphic map docblock above `meetingContextTypeEnum` in `../schema/enums.ts` —
 ...
 *   3. The `meeting_context_admin_no_id` CHECK (`context_id IS NULL ⟺ context_type='admin'`).
