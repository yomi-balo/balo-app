 ...
 * today, the inactivity sweep next) that it MUST, post-commit, mint a review token and publish
...
const PINNED_REPOSITORIES: readonly string[] = [
  ...
  'representations.ts',
  /**
   * BAL-541 (plan §20 item 2) adds the two Balo-owner / internal-notes repositories, for the
   * same reason: BOTH sit at exactly the "publish-after-commit adjacency" this pin exists for.
   *
