 ...
 * assigned to this ticket — IN THE RESCHEDULE DIRECTION ONLY. `cancel()`'s guard is UNCHANGED and
 * BAL-410 inherits the cancel side. Three reasons the window may not move once it has opened:
