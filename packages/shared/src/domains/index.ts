 ...
 * the BAL-350 signup prefill: founder@acme.com → "Acme", jane@acme-corp.io →
 * "Acme Corp". Returns '' for blocked/freemail or unusable input (so a freemail
 * signup shows an empty field, not "Gmail"). PURE — no I/O, no db.
 */
