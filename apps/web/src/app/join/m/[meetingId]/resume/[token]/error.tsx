...
/**
 * BAL-442 — the resume segment's error boundary.
 *
 ...
 * sibling `m/[meetingId]/error.tsx` does exactly this, and for the same reason.
 *
 ...
 */
export default function LobbyResumeError({
  reset,
  ...
  return (
    <div className="border-border bg-card mx-auto w-full max-w-md rounded-2xl border p-8 text-center shadow-sm">
      ...
      <p className="text-muted-foreground mt-2 text-[13px] leading-relaxed">
        We couldn&apos;t get you back in just now. Please try again in a moment.
      </p>
      <button
        type="button"
        onClick={reset}
