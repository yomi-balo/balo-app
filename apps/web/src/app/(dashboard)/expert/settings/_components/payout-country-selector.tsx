...
interface PayoutCountrySelectorProps {
  value: string;
  onCountryChange: (code: string, currency: string) => void;
  disabled?: boolean;
}

export function PayoutCountrySelector({
  value,
  onCountryChange,
  disabled = false,
}: PayoutCountrySelectorProps): React.JSX.Element {
            ...
            <CommandGroup heading="Popular">
              {priorityCountries.map((country) => (
                <CountryItem
                  ...
                  onSelect={() => {
                    onCountryChange(country.code, country.currency);
                    setOpen(false);
                  }}
                />
              ))}
