    ...
    <Form {...form}>
      <form className="mx-auto max-w-lg space-y-6">
        ...
        <p className="text-muted-foreground -mt-2 text-sm">
          Invite colleagues to join Balo. Totally optional &mdash; you can always do this from your
          dashboard later.
        </p>
        ...
        <FormField
          ...
          render={() => (
            <FormItem>
              ...
              <FormDescription>
                Enter email addresses separated by commas or new lines. We&apos;ll send each person
        ...
        <p className="text-muted-foreground text-xs">
          We&apos;ll only send one invitation email per address. Your colleagues can apply whenever
          they&apos;re ready.
        </p>
