...
/**
 * Single copy for BOTH a missing request (404) AND an unauthorised viewer — a
 * non-participant cannot distinguish "doesn't exist" from "exists but not yours"
 * (no existence leak).
 */
export default function RequestNotFound(): React.JSX.Element {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      ...
      <h3 className="text-foreground text-lg font-semibold">Request not found</h3>
