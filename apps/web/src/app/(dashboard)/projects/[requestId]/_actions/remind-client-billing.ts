 ...
 *
 * Authorization: platform capability `MANAGE_ANY_KICKOFF_GATE` — session, then the LIVE row —
 * via `requireRequestStaffCapability` (BAL-558). IDOR-safe: the relationship must belong to the
 * request (else `NOT_ON_REQUEST`).
 */
