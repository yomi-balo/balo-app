...
/**
 * BAL-549 — recoverable error boundary for the applications list. Mirrors `admin/catalogue/
 * error.tsx`: centred destructive glyph + reassurance + a single "Try again" that calls
 * `reset()`.
 */
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      ...
      <h3 className="text-foreground text-lg font-semibold">
        The applications list didn&apos;t load
      </h3>
