...
/* eslint-disable react/prop-types -- Vendored shadcn/react-day-picker primitive: inline render-prop components (Root/Chevron/WeekNumber) are type-checked by TypeScript, not PropTypes. */
