...
/**
 * Selectable taxonomy option chip (tags / products). Generalised from the search
 * composer's `ProductChip` — same `aria-pressed` checkbox-style toggle,
 * light-primary selected state (not a solid fill), and a reduced-motion-gated
 * tap-scale.
 */
export function TaxonomyChip({
  ...
  selected,
  onToggle,
}: Readonly<TaxonomyChipProps>): React.JSX.Element {
